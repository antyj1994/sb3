...
insert into permesso(id, nome, descrizione) values (0, 'DELETE', 'this permission let`s you delete users');

insert into permessoutente(id_utente, id_permesso) values (0, 0), (100, 0);